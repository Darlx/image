...
In this document, if two screenshots of the same process are provided, the later is made on windows.
...
1. Search how to download VSCode as your IDE. Search how to download **Anaconda** in your computer. Meanwhile, you will get a command line tool called **conda**. Use `conda --version` to check whether it exists on VSCode console.
   ...
   <img width="920" alt="image" src="https://github.com/Darlx/image/raw/3bc7959930722ba46bd52c120bcd7ae1c5449986/img2/1.png">
...
2. Create a virtual environment using `conda create --name geo python=3.9 `.It would create a new Conda environment named "**geo**" with Python version 3.9.
   ...
   <img width="919" alt="image" src="https://github.com/Darlx/image/raw/3bc7959930722ba46bd52c120bcd7ae1c5449986/img2/2.1.png">
   ...
   <img width="918" alt="image" src="https://github.com/Darlx/image/blob/3bc7959930722ba46bd52c120bcd7ae1c5449986/img2/2.2.png">
...
3. Activate your created virutal environment through `conda activate geo` . Once it is activated, the head your command line would change from **(base)** into **(geo)**.
   ...
   <img width="920" alt="image" src="https://github.com/Darlx/image/raw/3bc7959930722ba46bd52c120bcd7ae1c5449986/img2/3.1.png">
   ...
   <img width="903" alt="image" src="https://github.com/Darlx/image/raw/3bc7959930722ba46bd52c120bcd7ae1c5449986/img2/3.2.png">
...
4. Go into the directory **requirments** and download necessary dependencies to run Python code by executing `pip install -r development.txt`. Then wait until all dependencies are downloaded.
   ...
   <img width="912" alt="image" src="https://github.com/Darlx/image/raw/3bc7959930722ba46bd52c120bcd7ae1c5449986/img2/4.1.png">
   ...
   <img width="909" alt="image" src="https://github.com/Darlx/image/raw/3bc7959930722ba46bd52c120bcd7ae1c5449986/img2/4.2.png">
...
5. Now you can test our command-line-interface (CLI) software locally by navigating to the directory **geochemistrypi **and then execute `python start_cli_pipeline.py`. You can press **ctrl + C** to stop anytime in the middle.
   ...
   <img width="910" alt="image" src="https://github.com/Darlx/image/raw/3bc7959930722ba46bd52c120bcd7ae1c5449986/img2/5.1.png">

   <img width="910" alt="image" src="https://github.com/Darlx/image/raw/3bc7959930722ba46bd52c120bcd7ae1c5449986/img2/5.2.png">

   <img width="910" alt="image" src="https://github.com/Darlx/image/raw/3bc7959930722ba46bd52c120bcd7ae1c5449986/img2/5.4.png">
   ...
   <img width="934" alt="image" src="https://github.com/Darlx/image/raw/3bc7959930722ba46bd52c120bcd7ae1c5449986/img2/5.3.png">
   ...
   <img width="1259" alt="image" src="https://github.com/Darlx/image/raw/3bc7959930722ba46bd52c120bcd7ae1c5449986/img2/5.6.png">
   ...
   <img width="1261" alt="image" src="https://github.com/Darlx/image/raw/3bc7959930722ba46bd52c120bcd7ae1c5449986/img2/5.7.png">
   ...
   <img width="1261" alt="image" src="https://github.com/Darlx/image/raw/3bc7959930722ba46bd52c120bcd7ae1c5449986/img2/5.8.png">
...
6. In order to activate the frontend server, you need to search how to download **node.js** (find the version suitable your computer) firstly. After installing Node.js, verify that npm is installed correctly. You can open a new terminal or command prompt on VSCode and use `npm --version`.
   ...
   <img width="968" alt="image" src="https://github.com/Darlx/image/raw/3bc7959930722ba46bd52c120bcd7ae1c5449986/img2/6.1.png">
   ...
   <img width="960" alt="image" src="https://github.com/Darlx/image/raw/3bc7959930722ba46bd52c120bcd7ae1c5449986/img2/6.2.png">
   ...
   <img width="924" alt="image" src="https://github.com/Darlx/image/raw/3bc7959930722ba46bd52c120bcd7ae1c5449986/img2/6.3.png">
